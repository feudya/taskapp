...
/* base.html.twig */
class __TwigTemplate_c750602edc9fdf31581cc54b55f2da0b31a9479b6c7fb2fe405bdaa0ee757564 extends Twig_Template
{
    private $source;
...
\t\t<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">
\t\t<!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->
\t\t<title>Task App - {% block titulo %}{% endblock %}</title>
\t\t<!-- Bootstrap -->
\t\t{% block stylesheets %}
...
\t\t\t\t\t\t<span class=\"icon-bar\"></span>
\t\t\t\t\t\t</button>
\t\t\t\t\t\t<a class=\"navbar-brand\" href=\"{{ path('homepage') }}\">TaskApp</a>
\t\t\t\t\t</div>
\t\t\t\t\t<div id=\"navbar\" class=\"collapse navbar-collapse\">
\t\t\t\t\t\t<ul class=\"nav navbar-nav\">
...
\t\t<!-- Include all compiled plugins (below), or include individual files as needed -->
\t</body>
</html>", "base.html.twig", "/var/www/mescyt/taskapp/app/Resources/views/base.html.twig");
    }
}
