...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Forms\\TicketForm\\TicketForms' => function () {
    return ${($_ = isset($this->services['AppBundle\Forms\TicketForm\TicketForms']) ? $this->services['AppBundle\Forms\TicketForm\TicketForms'] : $this->services['AppBundle\Forms\TicketForm\TicketForms'] = new \AppBundle\Forms\TicketForm\TicketForms()) && false ?: '_'};
}, 'AppBundle\\Forms\\UsuarioForm\\UsuarioForms' => function () {
    return ${($_ = isset($this->services['AppBundle\Forms\UsuarioForm\UsuarioForms']) ? $this->services['AppBundle\Forms\UsuarioForm\UsuarioForms'] : $this->services['AppBundle\Forms\UsuarioForm\UsuarioForms'] = new \AppBundle\Forms\UsuarioForm\UsuarioForms()) && false ?: '_'};
